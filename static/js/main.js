// Main JavaScript for Sistema de Gestão de Estoque
...
function updateProductStock(productId, newStock) {
    return fetchData(`/api/produtos/${productId}/estoque`, {
        method: 'PUT',
        body: JSON.stringify({ estoque_atual: newStock })
    });
}

// Request management functions
function updateRequestStatus(requestId, status) {
    return fetchData(`/api/solicitacoes/${requestId}/status`, {
        method: 'PUT',
...
function initRealTimeUpdates() {
    ...
    // for real-time updates of stock levels and request statuses
